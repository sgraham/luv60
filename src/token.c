...
static DictImpl* token_import_dict;
...
TokenKind token_var_or_import(uint32_t offset, uint32_t next_offset) {
  ...
  DictRawIter iter = dict_find(token_import_dict, &str, start_str_hash_func, start_str_eq_func,
